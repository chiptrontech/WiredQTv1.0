...
class Handler(QtWidgets.QWidget,usercontrol):
	...
	def GTKForms(self):
		...
		self.createwidget("{'Picture': 'logo.png', 'Name': 'QLabel12', 'Events': [], 'Enable': 'True', 'Tag': '', 'Width': '1080', 'Help': '', 'Text': '', 'Height': '700', 'Left': '0', 'Var': '', 'Font': '', 'Top': '32', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'ParentsType': '', 'ForeColor': '(0,0,0,1)'}",'QLabel','usercontrol',"[]")
