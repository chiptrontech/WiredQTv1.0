...
class Handler(object):
	...
	def GTKForms(self):
		...
		self.Image1=forms
		self.create("{'Picture': 'MedicationsSubModule-6e7dd.png', 'Tag': '', 'Height': '645', 'Width': '405', 'Enable': 'True', 'Var': '', 'Events': '[[, ]]', 'ForeColor': '(0,0,0,1)', 'Left': '0', 'ParentsType': 'Layout', 'BackColor': '(1,1,1,1)', 'Top': '0', 'Text': '', 'Name': 'Image1', 'Visible': 'True', 'Font': '', 'Help': ''}","Image","mBase","[]")
		self.btnOrder=forms
		self.create("{'Picture': '', 'Tag': '', 'Height': '30', 'Width': '165', 'Enable': 'True', 'Var': '', 'Events': '[[, ]]', 'ForeColor': '(0,0,0,1)', 'Left': '115', 'ParentsType': 'Layout', 'BackColor': '(0, 0.5947705885149066, 0.6256477024706841, 0.5)', 'Top': '195', 'Text': '', 'Name': 'btnOrder', 'Visible': 'True', 'Font': '', 'Help': ''}","Layout","mBase","[]")
		self.btnBack=forms
		...
		self.create("{'Picture': '', 'Tag': '', 'Height': '30', 'Width': '110', 'Enable': 'True', 'Var': '', 'Alignment': '', 'Events': '[[, ]]', 'ForeColor': '(0,0,0,1)', 'Left': '265', 'ParentsType': 'Layout', 'BackColor': '(1,1,1,1)', 'Top': '260', 'Text': '', 'Name': 'lblDispenses1', 'Visible': 'True', 'Font': '', 'Help': ''}","Label","mBase","[]")
		...
		self.create("{'Picture': '', 'Tag': '', 'Height': '30', 'Width': '110', 'Enable': 'True', 'Var': '', 'Alignment': '', 'Events': '[[, ]]', 'ForeColor': '(0,0,0,1)', 'Left': '265', 'ParentsType': 'Layout', 'BackColor': '(1,1,1,1)', 'Top': '390', 'Text': '', 'Name': 'lblDispenses2', 'Visible': 'True', 'Font': '', 'Help': ''}","Label","mBase","[]")
		self.lblDesc2=forms
		...
		self.create("{'Picture': '', 'Tag': '', 'Height': '30', 'Width': '110', 'Enable': 'True', 'Var': '', 'Alignment': '', 'Events': '[[, ]]', 'ForeColor': '(0,0,0,1)', 'Left': '265', 'ParentsType': 'Layout', 'BackColor': '(1,1,1,1)', 'Top': '520', 'Text': '', 'Name': 'lblDispenses3', 'Visible': 'True', 'Font': '', 'Help': ''}","Label","mBase","[]")
		self.lblDesc3=forms
