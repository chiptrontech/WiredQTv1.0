...
Debug.ShouldStop(1073741824);
vb6.mostCurrent.__c.runVoidMethod ("LogImpl","22686989",BA.ObjectToString(RemoteObject.solveBoolean("=",vb6.mostCurrent.__c.runMethod(true,"GetType",(Object)((RemoteObject.createImmutable("")))),RemoteObject.createImmutable("java.lang.Integer"))),0);
 BA.debugLineNum = 128;BA.debugLine="Log(\"Key: \" & am.GetKeyAt(i))";
Debug.ShouldStop(-2147483648);
vb6.mostCurrent.__c.runVoidMethod ("LogImpl","22686990",RemoteObject.concat(RemoteObject.createImmutable("Key: "),_am.runMethod(false,"GetKeyAt",(Object)(BA.numberCast(int.class, _i)))),0);
 BA.debugLineNum = 129;BA.debugLine="Log(\"Value: \" & am.GetValueAt(i))";
Debug.ShouldStop(1);
vb6.mostCurrent.__c.runVoidMethod ("LogImpl","22686991",RemoteObject.concat(RemoteObject.createImmutable("Value: "),_am.runMethod(false,"GetValueAt",(Object)(BA.numberCast(int.class, _i)))),0);
 }
}Debug.locals.put("i", _i);
;
