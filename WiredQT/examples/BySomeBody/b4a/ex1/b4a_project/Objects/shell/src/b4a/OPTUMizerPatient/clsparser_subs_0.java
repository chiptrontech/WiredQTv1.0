...
try {
		Debug.PushSubsStack("available (clsparser) ","clsparser",5,__ref.getField(false, "ba"),__ref,36);
...
try {
		Debug.PushSubsStack("Databuffer (clsparser) ","clsparser",5,__ref.getField(false, "ba"),__ref,69);
...
try {
		Debug.PushSubsStack("Initialize (clsparser) ","clsparser",5,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("Pollbyte (clsparser) ","clsparser",5,__ref.getField(false, "ba"),__ref,24);
