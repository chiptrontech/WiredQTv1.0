...
anywheresoftware.b4a.keywords.Common.LogImpl("22686989",BA.ObjectToString((anywheresoftware.b4a.keywords.Common.GetType((Object)(""))).equals("java.lang.Integer")),0);
RDebugUtils.currentLine=2686990;
 //BA.debugLineNum = 2686990;BA.debugLine="Log(\"Key: \" & am.GetKeyAt(i))";
anywheresoftware.b4a.keywords.Common.LogImpl("22686990","Key: "+BA.ObjectToString(_am.GetKeyAt(_i)),0);
RDebugUtils.currentLine=2686991;
 //BA.debugLineNum = 2686991;BA.debugLine="Log(\"Value: \" & am.GetValueAt(i))";
anywheresoftware.b4a.keywords.Common.LogImpl("22686991","Value: "+BA.ObjectToString(_am.GetValueAt(_i)),0);
 }
};
