...
class Handler(QtWidgets.QWidget,usercontrol):
	...
	def imshow(self,cvImg):
		cv=cv2.cvtColor(cvImg,cv2.COLOR_BGR2RGB)
		self.Image1.LoadPictureOCV=cv
	...
	def GTKForms(self):
		self.createwidget("{'Name': 'Image1', 'Var': '', 'Font': '', 'Enable': 'True', 'Top': '0', 'Width': '100', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '30', 'Left': '0', 'Tag': '', 'Text': 'Image1', 'Help': ''}",'QLabel','usercontrol',"[]")
	def Widget(self):
		return self
