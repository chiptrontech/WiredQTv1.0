...
class Handler(QtWidgets.QWidget,usercontrol):	
	...
	def GTKForms(self):
		...
		self.createwidget("{'Events': '[clicked]', 'Width': '100', 'Name': 'Button12', 'Picture': '', 'Enable': 'True', 'BackColor': '(1,1,1,1)', 'Var': '', 'ParentsType': '', 'Help': '', 'Top': '131', 'Visible': 'True', 'Height': '50', 'Text': 'Train', 'Left': '1008', 'Tag': '', 'ForeColor': '[1.0, 0.0, 0.0, 1.0]', 'Font': 'Sans Bold Italic 12'}",'QPushButton','usercontrol',"[['clicked', 'self,e']]")
		...
		self.createwidget("{'Width': '100', 'Enable': 'False', 'Picture': '', 'Name': 'Button2', 'BackColor': '(1,1,1,1)', 'Var': '', 'Height': '30', 'ForeColor': '[0.0, 0.6666666666666666, 0.0, 1.0]', 'Help': '', 'Top': '29', 'Visible': 'True', 'ParentsType': '', 'Text': 'Train Folder', 'Left': '650', 'Tag': '', 'Events': '[clicked]', 'Font': ''}",'QPushButton','usercontrol',"[['clicked', 'self,e']]")
	...
	def ctlbox1_draw(self):
		...
		try:
			name=self.MsgBox1.obj.getItem(self,"Select Here","Classes",self.classes)
