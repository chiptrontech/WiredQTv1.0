...
class Handler(QtWidgets.QWidget,usercontrol):	
	...
	def LoadImageFolder(self,folder="train"):
		...
		if folder=="train":
			...
			self.caller.frmcamera2.QPushButton2.Text="Save To Train Folder"
			self.caller.frmcamera2.QPushButton2.Enable=True
		else:
			self.Button2.ForeColor=(0,0,1,1)
			self.Button1.ForeColor=(1,0,0,1)
			self.caller.frmcamera2.QPushButton2.Text="Save To Test Folder"
			self.caller.frmcamera2.QPushButton2.Enable=True
