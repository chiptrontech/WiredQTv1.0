...
class Handler(QtWidgets.QWidget,usercontrol):
	...
	def QPushButton2_clicked(self,arg1):
		...
		try:
			fname=self.caller.frmtraining1.Label1.Text+"/" + CreateFileName() + ".jpg"# save as datetime.jpg
			cv2.imwrite(fname,self.frame)
			if self.QPushButton2.Text.find("Train")!=-1:
				self.caller.frmtraining1.Button2_clicked(None)
			else:
				self.caller.frmtraining1.Button1_clicked(None)
		except:
